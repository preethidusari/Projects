...
const LandingPageNavbar = ({ logged }: { logged: boolean }) => {
      ...
      <MaxWidthWrapper>
        <div className="lg:px-2 pt-1 flex justify-between items-center">
          ...
          {logged ? (
            ...
            <div className="flex items-center space-x-4">
            <LogoutLink className="z-10 px-5 py-2 rounded-lg text-purple-700 bg-white text-lg font-semibold hover:shadow-md hover:underline duration-100 ">
              Sign Out
            </LogoutLink>
          </div>
          )}
